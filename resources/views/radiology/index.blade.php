...
@section('page-title', 'Antrian Radiologi')
@section('page-subtitle', 'Order pemeriksaan imaging dan hasil radiologi')
        ...
        <table class="table mb-0">
            ...
            @forelse($orders as $order)
                <tr>
                    ...
                    <td>{{ $order->result ? 'Terverifikasi' : 'Belum ada' }}</td>
                    <td><a href="{{ route('rad.hasil.edit', $order) }}" class="btn btn-sm btn-simrs-primary"><i class="fa-solid fa-x-ray me-1"></i>Input</a></td>
                </tr>
            @empty
                <tr><td colspan="8" class="text-center text-muted py-4">Tidak ada order radiologi.</td></tr>
            @endforelse
            </tbody>
        </table>
    </div>
