            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center gap-3 mb-4">
                        ...
                        <h5 class="fw-bold text-dark mb-0">Update Identitas Utama</h5>
                    </div>
                    ...
                    <div class="row g-4 mb-5">
                        <div class="col-md-3">
                            ...
                            <input value="{{ $patient->no_rkm_medis }}" class="form-control border-light bg-light fw-bold text-primary font-monospace py-2" readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label text-muted fw-semibold small mb-2 text-uppercase" style="letter-spacing: 0.5px;">NIK (Sesuai KTP)</label>
                            <input name="nik" value="{{ old('nik', $patient->nik) }}" class="form-control border-light bg-light fw-medium font-monospace py-2 shadow-none focus-ring-0" placeholder="32xxxxxxxxxxxxxx" required maxlength="20">
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <input name="no_bpjs" value="{{ old('no_bpjs', $patient->no_bpjs) }}" class="form-control border-light border-start-0 ps-0 bg-light font-monospace py-2 shadow-none focus-ring-0" placeholder="0001xxxxxxxx">
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <input name="no_telp_pasien" value="{{ old('no_telp_pasien', $patient->no_telp_pasien) }}" class="form-control border-light border-start-0 ps-0 bg-light py-2 shadow-none focus-ring-0" placeholder="08xxxxxxxxxx">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 border-top border-light pt-4">
                            ...
                            <input name="nama_pasien" value="{{ old('nama_pasien', $patient->nama_pasien) }}" class="form-control border-light bg-light py-3 fw-bold text-dark fs-5 shadow-none focus-ring-0" placeholder="Masukkan nama sesuai kartu identitas" required>
                        </div>
                        <div class="col-md-3 border-top border-light pt-4">
                            ...
                            <div class="d-flex gap-4 pt-2">
                                <div class="form-check custom-radio">
                                    <input class="form-check-input focus-ring-0" type="radio" name="jenis_kelamin" value="L" id="jkL" @checked(old('jenis_kelamin', $patient->jenis_kelamin) === 'L')>
                                    <label class="form-check-label fw-medium text-dark" for="jkL">Laki-laki</label>
                                </div>
                                <div class="form-check custom-radio">
                                    <input class="form-check-input focus-ring-0" type="radio" name="jenis_kelamin" value="P" id="jkP" @checked(old('jenis_kelamin', $patient->jenis_kelamin) === 'P')>
                        ...
                        <div class="col-md-3">
                            ...
                            <input name="tempat_lahir" value="{{ old('tempat_lahir', $patient->tempat_lahir) }}" class="form-control border-light bg-light py-2 shadow-none focus-ring-0" placeholder="Kota lahir">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label text-muted fw-semibold small mb-2 text-uppercase" style="letter-spacing: 0.5px;">Tanggal Lahir</label>
                            <input type="date" name="tgl_lahir" value="{{ old('tgl_lahir', $patient->tgl_lahir?->format('Y-m-d')) }}" class="form-control border-light bg-light py-2 fw-medium shadow-none focus-ring-0" required>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input name="pendidikan" value="{{ old('pendidikan', $patient->pendidikan) }}" class="form-control border-light bg-light py-2 shadow-none focus-ring-0" placeholder="SMA / S1 / dst">
                        </div>
                    </div>

                    <!-- Update Domisili & Kontak -->
                    <div class="d-flex align-items-center gap-3 mb-4">
                        <div class="bg-primary bg-opacity-10 text-primary rounded-3 d-flex align-items-center justify-content-center flex-shrink-0" style="width: 44px; height: 44px;">
                            <i class="fa-solid fa-map-location-dot fs-5"></i>
                        </div>
                        <h5 class="fw-bold text-dark mb-0">Update Domisili & Kontak</h5>
                    </div>
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-12">
                            ...
                            <textarea name="alamat_lengkap" class="form-control border-light bg-light py-2 shadow-none focus-ring-0" rows="2" placeholder="Nama jalan, nomor rumah, RT/RW..." required>{{ old('alamat_lengkap', $patient->alamat_lengkap) }}</textarea>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold small text-muted">Kelurahan</label>
                            <input name="kelurahan" value="{{ old('kelurahan', $patient->kelurahan) }}" class="form-control border-light bg-light py-2 shadow-none focus-ring-0">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold small text-muted">Kecamatan</label>
                            <input name="kecamatan" value="{{ old('kecamatan', $patient->kecamatan) }}" class="form-control border-light bg-light py-2 shadow-none focus-ring-0">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold small text-muted">Kota / Kab</label>
                            <input name="kota" value="{{ old('kota', $patient->kota) }}" class="form-control border-light bg-light py-2 shadow-none focus-ring-0">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold small text-muted">Provinsi</label>
                            <input name="provinsi" value="{{ old('provinsi', $patient->provinsi) }}" class="form-control border-light bg-light py-2 shadow-none focus-ring-0">
                        </div>
                    </div>
                    ...
                    <div class="row g-4 border-top border-light pt-4">
                        <div class="col-md-6">
                            ...
                            <input name="kontak_darurat_nama" value="{{ old('kontak_darurat_nama', $patient->kontak_darurat_nama) }}" class="form-control border-light bg-light py-2 shadow-none focus-ring-0" placeholder="Nama lengkap keluarga">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label text-muted fw-semibold small mb-2 text-uppercase" style="letter-spacing: 0.5px;">Telepon Darurat</label>
                            <input name="kontak_darurat_telp" value="{{ old('kontak_darurat_telp', $patient->kontak_darurat_telp) }}" class="form-control border-light bg-light py-2 shadow-none focus-ring-0" placeholder="Nomor aktif">
                        </div>
                        <div class="col-12">
                            <div class="alert alert-danger bg-danger bg-opacity-10 border-0 rounded-4 p-4 d-flex gap-3 mb-0">
                                ...
                                <div class="w-100">
                                    ...
                                    <textarea name="alergi" class="form-control border-0 bg-white shadow-none py-2 text-danger fw-medium" rows="2" placeholder="Tuliskan 'TIDAK ADA' jika tidak ada riwayat alergi spesifik...">{{ old('alergi', $patient->alergi) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 sticky-top" style="top: 90px;">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center gap-3 mb-4">
                        ...
                        <h6 class="fw-bold text-dark mb-0">Simpan Perubahan</h6>
                    </div>

                    <div class="p-3 rounded-3 bg-info bg-opacity-10 border-0 mb-4 text-center">
                        <div class="small fw-bold text-info mb-2 text-uppercase" style="letter-spacing: 0.5px;">Informasi Sistem:</div>
                        <div class="small fw-medium text-dark opacity-75">Update terakhir pada:<br>{{ $patient->updated_at->format('d/m/Y H:i') }}</div>
                    </div>
                    ...
                    <a href="{{ route('pendaftaran.pasien.show', $patient) }}" class="btn btn-light border w-100 fw-bold py-3 rounded-pill text-muted hover-bg-gray transition-hover">
                        BATALKAN
                    </a>
                </div>
            </div>
